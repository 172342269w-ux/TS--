...
//     head->next = newNode;
// }
function insertAtHead(head: Node, data: ElementType): void {
...
//     printf("\n");
// }
function traverseList(head: Node): void {
...
//     return current;
// }
function getTail(head: Node): Node {
    let current = head;
    while (current.next !== null) {
        current = current.next;
    }
...
function insertAtTail(head: Node, e: ElementType): void {
...
function insertAtPosition(head: Node, e: ElementType, position: number): void {
    const newnode = new Node(e);
...
function deleteNode(head: Node, e: ElementType): void {
